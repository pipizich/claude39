    ...
    displayEnhancedMetadata(metadata) {
            ...
            html += `
                <div class="collapsible-section expanded">
                    <div class="section-header" onclick="window.galleryLightbox?.toggleSection?.(this)">
                        <h5><i class="fa-thin fa-microchip-ai"></i> MODEL & LORA</h5>
        ...
        if (paramItems.length > 0) {
            html += `
                <div class="collapsible-section expanded">
                    <div class="section-header" onclick="window.galleryLightbox?.toggleSection?.(this)">
                        <h5><i class="fa-thin fa-gear-complex"></i> GENERATION PARAMETERS</h5>
        ...
        if (hasSize || hasDate || hasAspectRatio) {
            html += `
                <div class="collapsible-section expanded">
                    <div class="section-header" onclick="window.galleryLightbox?.toggleSection?.(this)">
                        <h5><i class="fa-light fa-square-info"></i> IMAGE DETAILS</h5>
                        <span class="toggle-icon"><i class="fas fa-chevron-down"></i></span>
                    </div>
                    <div class="section-content">
                        <div class="metadata-grid">
            ...
            html += `
                <div class="prompt-section">
                    <div class="prompt-header">
                        <h6><i class="fa-thin fa-pen-to-square"></i> PROMPT</h6>
                        <button class="prompt-copy-btn" onclick="window.galleryLightbox?.copyToClipboard?.('${this.core.escapeForJs(prompt)}')"><i class="fa-thin fa-clipboard"></i> Copy</button>
                    </div>
            ...
            case 'copyable':
                valueHtml = `
                    <div class="metadata-value copyable-text">
                        ...
                        <button class="copy-btn" onclick="window.galleryLightbox?.copyToClipboard?.('${this.core.escapeForJs(item.value)}')"><i class="fa-thin fa-clipboard"></i></button>
                    </div>
                `;
                break;
